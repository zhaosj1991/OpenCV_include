 ...
 * size, etc). Note that the CUDA driver will set the \p limit to the maximum of \p value and what the kernel function requires. The application can use ::cudaDeviceGetLimit() to find out
